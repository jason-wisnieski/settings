...
function __fish_git_prompt_informative_status
    ...
    if test -z "$state"
		...
		# whether dirty or clean, display number of stash entries
		if test -f (command git rev-parse --git-dir)/logs/refs/stash
			set -l stashedfiles (wc -l < (command git rev-parse --git-dir)/logs/refs/stash)
			set -l color $___fish_git_prompt_color_stashstate
			set -l color_done $___fish_git_prompt_color_stashstate_done
			set -l symbol $___fish_git_prompt_char_stashedfiles

			set -l count $stashedfiles
...
function __fish_git_prompt_validate_chars --description "__fish_git_prompt helper, checks char variables"
    ...
    __fish_git_prompt_set_char __fish_git_prompt_char_upstream_prefix ''
		__fish_git_prompt_set_char __fish_git_prompt_char_stashedfiles '$' '§'
